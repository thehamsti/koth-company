...
export interface Config {
  ...
  fallbackLocale: null;
  globals: {
    "tournament-settings": TournamentSetting;
  };
  globalsSelect: {
    "tournament-settings": TournamentSettingsSelect<false> | TournamentSettingsSelect<true>;
  };
  locale: null;
  widgets: {
...
/**
 * Reusable player directory for fast leaderboard entry and autocomplete.
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface Participant {
  id: number;
  /**
   * Saved once, then searchable whenever this player returns.
   */
  displayName: string;
  /**
   * Optional reference for tournament operators.
   */
  faction?: ("Horde" | "Alliance") | null;
  /**
   * Private operator notes; never shown on the public site.
   */
  notes?: string | null;
  updatedAt: string;
  createdAt: string;
...
export interface LeaderboardEntry {
  ...
  /**
   * Their best consecutive wins for this event.
   */
  wins: number;
...
/**
 * Control the active event, page copy, and viewer destinations.
 *
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "tournament-settings".
 */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "tournament-settings_select".
 */
export interface TournamentSettingsSelect<T extends boolean = true> {
  expansion?: T;
  season?: T;
  week?: T;
  heroSlogan?: T;
